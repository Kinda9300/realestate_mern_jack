            ...
            <div className="permit-accordian-div" id="item-5-3">
                <AccordionComponent>
                    <AccordionItemsDirective>
                        <AccordionItemDirective header="Current Owner" content={childcomp} />
                    </AccordionItemsDirective>
                </AccordionComponent>
            </div>
            <div className="permit-accordian-div" id="item-5-3">
                <AccordionComponent>
                    <AccordionItemsDirective>
                        <AccordionItemDirective header="Previous Sales" content={childcomp} />
                    </AccordionItemsDirective>
                </AccordionComponent>
            </div>
            <div className="permit-accordian-div" id="item-5-3">
                <AccordionComponent>
                    <AccordionItemsDirective>
                        <AccordionItemDirective header="HomeOnwer Association Information" content={childcomp} />
                    </AccordionItemsDirective>
                </AccordionComponent>
            </div>
        </div>
